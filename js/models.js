...
class Story {
  ...
  // No instructions given about this part?. Would like to discuss more on it.
}
...
class StoryList {
  ...
  async addStory(currentUser, newStory) {
    ...
    // Add the story to our story list
    this.stories.unshift(story);
    // Add the story to the users stories
...
class User {
  ...
  // Add to users favorites, and send to favorites in the API
  ...
  // fromove from users favorites, and delete from favorites in the API
  ...
  // Return true or false if story is favorited by this user.
  isFavorite(story) {
